...
\hline
\multirow{2}{*}{\textbf{Mean}}                    & \textbf{} & \textbf{} &  &  \\
                                                  &           &           &  &  \\ \hline
\multirow{2}{*}{\textbf{SD}}                      &           &           &  &  \\
                                                  &           &           &  &  \\ \hline
\multirow{2}{*}{\textbf{$\mathbf{Q}_1$}}          &           &           &  &  \\
                                                  &           &           &  &  \\ \hline
\multirow{2}{*}{\textbf{$\mathbf{Q}_2$ (Median)}} &           &           &  &  \\
                                                  &           &           &  &  \\ \hline
\multirow{2}{*}{\textbf{$\mathbf{Q}_3$}}          &           &           &  &  \\
                                                  &           &           &  &  \\ \hline
\multirow{2}{*}{\textbf{IQR}}                     &           &           &  &  \\
                                                  &           &           &  &  \\ \hline
\end{tabular}
\end{minipage}
...
```{r echo=FALSE,eval=TRUE,out.width='100%',fig.width=7,fig.height=2, fig.align='center'}
A <- 5:11
ggplot(data,aes(x=A)) + 
  ylab("") + 
  scale_x_continuous("A", labels = as.character(A), breaks = A) + 
  theme_minimal() + 
