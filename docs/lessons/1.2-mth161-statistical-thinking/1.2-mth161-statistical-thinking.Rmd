...
The analysis anticipates:
  ...
  2. **Uncertainty.** Because data varies, we’re often unsure about the "true" answer to a question.
...
**Steps in Statistical Thinking:** 
  ...
  4. Evaluate results and make a conclusion
::::
...
* Understanding Data Fundamentals
    ...
    - Structure, collection methods, and limitations.
    - Assessing impacts on inferential validity.

* Data Presentation & Descriptive Statistics

    - Effective graphical methods.
    - Computing key descriptive measures.
::::

:::: {.column width=48%}
* Statistical Analysis

    - Analyze individual variables and relationships.
...
* Linear Regression Models
  ...
  - Appropriate use and contextual interpretation.
...
* Critical Data Assessment
  ...
  - Evaluate claims using data-driven evidence.

* R for Data Analysis

  - Execute basic R code for analysis, modeling, and visualization.
::::
