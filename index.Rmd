...
|  | F 2/7 | Considering Categorical Data |
| **5** | M 2/10 | Basic Data Visualizations & <br>**Homework 2** |
|  | W 2/12 | Basic Probability |
|  | F 2/14 | Conditional Probability |
| **6** | M 2/17 | **Assessments 2** |
|  | W 2/19 | Binomial Distribution |
|  | F 2/21 | Normal Distribution |
| **7** | M 2/24 | Practical Sampling & <br>**Homework 3** |
|  | W 2/26 | Point Estimates and Sampling Variability |
|  | F 2/28 | Confidence Intervals |
| **8** | M 3/3 | _Spring Vacation_ |
|  | W 3/5 | _Spring Vacation_ |
|  | F 3/7 | _Spring Vacation_ |
| **9** | M 3/10 | **Assessments 3** |
|  | W 3/12 | Decision Errors |
|  | F 3/14 | Inference for One Proportion |
| **10** | M 3/17 | Hypothesis Testing for Proportions & <br>**Homework 4** |
|  | W 3/19 | Inference for Difference of Two Proportions |
|  | F 3/21 | Testing for Goodness of Fit |
| **11** | M 3/24 | **Assessments 4** |
|  | W 3/26 | Testing Independence in Two-Way Tables |
...
| R and R Studio | - |
| R Markdown | - |
| Data Basics &<br>Descriptive Statistics | Pg. 12-18 @diez2012openintro |
| Basic Data Structures | - |
| Sampling Principles and Strategies | Pg. 22-28 @diez2012openintro |
| Observational and Experimental Studies | Pg. 32-34 @diez2012openintro |
| Examining Numerical Data | Pg. 41-55 @diez2012openintro |
| Considering Categorical Data | Pg. 61-68 @diez2012openintro |
| Basic Data Visualizations | - |
| Basic Probability | Pg. 81-91 @diez2012openintro |
| Conditional Probability | Pg. 95-108 @diez2012openintro |
| Binomial Distribution | Pg. 149-155 @diez2012openintro |
| Normal Distribution | Pg. 133-141 @diez2012openintro |
| Practical Sampling | - |
| Point Estimates and Sampling Variability | Pg. 170-178 @diez2012openintro |
| Confidence Intervals | Pg. 181-186 @diez2012openintro |
...
| Testing for Goodness of Fit | Pg. 229-238 @diez2012openintro |
| Testing Independence in Two-Way Tables | Pg. 240-244 @diez2012openintro |
