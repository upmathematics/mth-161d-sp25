...
| **Introduction to R and R Studio** | **IRRS1:** Navigate the RStudio interface and explain its key components.<br>**IRRS2:** Run basic R commands and interpret their outputs | **IRRS3:** Install and load R packages relevant to data analysis. |
| **Introduction to R Markdown** | **IRM1:** Create and compile a basic R Markdown document.<br>**IRM2:** Use R Markdown to integrate narrative text, code, and visualizations. | **IRM3:** Format R Markdown documents for clear and professional presentation. |
...
| **Sampling Principles and Strategies** | **SPS1:** Describe key sampling techniques (simple random, stratified, cluster). | **SPS2:** Evaluate the strengths and limitations of various sampling strategies. |
...
| **Examining Numerical Data** | **END1:** Identify patterns, outliers, and trends in numerical data.<br>**END2:** Compute and interpret key summary statistics for numerical datasets. | **END3:** Use R to create visualizations such as scatter plots and line graphs. |
| **Considering Categorical Data** | **CCD1:** Summarize categorical data using frequency tables and bar charts.<br>**CCD2:** Compute and interpret proportions and relative frequencies. | **CCD3:** Use R to analyze and visualize categorical data. |
| **Basic Data Visualizations** | **BDV1:** Choose appropriate visualizations for different data types and distributions. |  |
| **Basic Probability** | **BP1:** Define and calculate probabilities using basic rules (addition and multiplication).<br>**BP2:** Interpret probability in context. |  |
...
| **Practical Sampling** |  | **PS1:** Simulate random sampling from data using R. |
| **Point Estimates and Sampling Variability** | **PESV1:** Explain the concepts of point estimates and variation.<br>**PESV2:** Define and explain the null and alternative hypothesis in context.<br>**PESV3:** Explain and interpret the p-value. |  |
| **Confidence Intervals** | **CI1:** Explain and interpret confidence intervals. |  |
| **Decision Errors** | **DE1:** Define Type I and Type II errors and their implications in hypothesis testing. | **DE2:** Evaluate the impact of sample size and significance level on decision errors. |
...
| **Week** | **Day** | **Topic** | **Read** |
|:---:|:----:|:---------------:|:----:|
| **1** | M 1/13 | [Orientation](lessons/1.1-orientation/1.1-orientation.html?presentme=true) | Syllabus |
...
|  | F 1/24 | Data Basics & <br>Descriptive Statistics | Pg. 12-18 @diez2012openintro |
| **3** | M 1/27 | Basic Data Structures & <br>**Homework 1** | - |
|  | W 1/29 | Sampling Principles and Strategies | Pg. 22-28 @diez2012openintro |
|  | F 1/31 | Observational and Experimental Studies | Pg. 32-34 @diez2012openintro |
| **4** | M 2/3 | **Assessments 1** | - |
|  | W 2/5 | Examining Numerical Data | Pg. 41-55 @diez2012openintro |
|  | F 2/7 | Considering Categorical Data | Pg. 61-68 @diez2012openintro |
...
|  | W 2/26 | Point Estimates and Sampling Variability | Pg. 170-178 @diez2012openintro |
|  | F 2/28 | Confidence Intervals | Pg. 181-186 @diez2012openintro |
| **8** | M 3/3 | _Spring Vacation_ | - |
|  | W 3/5 | _Spring Vacation_ | - |
|  | F 3/7 | _Spring Vacation_ | - |
| **9** | M 3/10 | **Assessments 3** | - |
|  | W 3/12 | Decision Errors | Pg. 189-201 @diez2012openintro |
|  | F 3/14 | Inference for One Proportion | Pg. 208-213 @diez2012openintro |
| **10** | M 3/17 | Hypothesis Testing for Proportions & <br>**Homework 4** | - |
|  | W 3/19 | Inference for Difference of Two Proportions | Pg. 217-224 @diez2012openintro |
|  | F 3/21 | Testing for Goodness of Fit | Pg. 229-238 @diez2012openintro |
| **11** | M 3/24 | **Assessments 4** | - |
|  | W 3/26 | Testing Independence in Two-Way Tables | Pg. 240-244 @diez2012openintro |
|  | F 3/28 | Inference for One Mean | Pg. 251-258 @diez2012openintro |
| **12** | M 3/31 | Hypothesis Testing for Means & <br>**Homework 5** | - |
|  | W 4/2 | Inference for Difference of Two Means | Pg. 267-273 @diez2012openintro |
|  | F 4/4 | Inference for Paired Means | Pg. 262-264 @diez2012openintro |
