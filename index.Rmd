...
| **Linear Regression** | **LR1:** Estimate and interpret the slope and intercept of a regression line in context. <br>**LR2:** Explain the meaning of the correlation coefficient. |  |
| **Least-Squares Regression** | **LSR1:** Explain the method of least-squares regression. <br>**LSR2:** Understand the concept of residuals and interpret regression errors. | **LSR2:** Fit a least-squares regression line to a dataset using R. |
| **Inference for Linear Regression** | **ILR1:** Construct confidence intervals for regression coefficients. <br>**ILR2:** Evaluate assumptions, interpret p-values, and confidence interval for regression coefficients. |  |
...
| **10** | M 3/17 | Inference for One Proportion |
|  | W 3/19 | Hypothesis Testing for Proportions |
|  | F 3/21 | Decision Errors |
| **11** | M 3/24 | **Assessments 4** |
|  | W 3/26 | _Cancelled_ |
|  | F 3/28 | Inference for One-Way and Two-Way Tables |
| **12** | M 3/31 | Inference for One Mean & <br>**Homework 4** |
|  | W 4/2 | Inference for Difference of Two Means |
|  | F 4/4 | Hypothesis Testing for Means |
| **13** | M 4/7 | **Assessments 5** |
|  | W 4/9 | Linear Regression |
|  | F 4/11 | Least-Squares Regression |
| **14** | M 4/14 | Inference for Linear Regression & <br>**Homework 5** |
|  | W 4/16 | Hypothesis Testing for Linear Regression |
|  | F 4/18 | _Easter vacation_ |
| **15** | M 4/21 | _Easter Vacation_ |
|  | W 4/23 | Multiple Linear Regression |
|  | F 4/25 | Comparing Many Means |
...
| [Inference for One Proportion](lessons/10.1-mth161-inference-for-one-proportion/10.1-mth161-inference-for-one-proportion.html) | Pg. 208-213 @diez2012openintro |
| [Hypothesis Testing for One Proportion](lessons/10.2-mth161-hypothesis-testing-for-one-proportion/10.2-mth161-hypothesis-testing-for-one-proportion.html) | - |
| [Decision Errors](lessons/10.3-mth161-decision-errors/10.3-mth161-decision-errors.html) | Pg. 189-201 @diez2012openintro |
| [Inference for One-Way and Two-Way Tables](lessons/11.1-mth161-inference-for-one-way-and-two-way-tables/11.1-mth161-inference-for-one-way-and-two-way-tables.html) | Pg. 229-238 & Pg. 240-244 @diez2012openintro |
| [Inference for One Mean](lessons/12.1-mth161-inference-for-one-mean/12.1-mth161-inference-for-one-mean.html) | Pg. 251-258 @diez2012openintro |
| [Inference for Difference of Two Means](lessons/12.2-mth161-inference-for-difference-of-two-means/12.2-mth161-inference-for-difference-of-two-means.html) | Pg. 267-273 @diez2012openintro |
| [Hypothesis Testing for Means](lessons/12.3-mth161-hypothesis-testing-for-means/12.3-mth161-hypothesis-testing-for-means.html) | - |
| [Linear Regression](lessons/13.1-mth161-linear-regression/13.1-mth161-linear-regression.html) | Pg. 305-311 @diez2012openintro |
| [Least-Squares Regression](lessons/13.2-mth161-least-squares-regression/13.2-mth161-least-squares-regression.html) | Pg. 317-324 @diez2012openintro |
| [Inference for Linear Regression](lessons/14.1-mth161-inference-for-linear-regression/14.1-mth161-inference-for-linear-regression.html) | Pg. 331-334 @diez2012openintro |
| [Hypothesis Testing for Linear Regression](lessons/14.2-mth161-hypothesis-testing-for-linear-regression/14.2-mth161-hypothesis-testing-for-linear-regression.html) | - |
| Multiple Linear Regression | Pg. 343-349 @diez2012openintro |
| Comparing Many Means | Pg. 285-294 @diez2012openintro |
