...
| **Inference** | **I1:** Identify and distinguish between two types of inference: parameter estimation and hypothesis testing. **I2:** Differentiate between a population and a sample based on their definitions and characteristics. |  |
| **Basic Probability** | **BP1:** Define and calculate probabilities using basic rules. <br>**BP2:** Interpret probability in context. |  |
...
| **5** | M 2/10 | Considering Categorical Data & <br>**Homework 2** |
|  | W 2/12 | Inference |
|  | F 2/14 | Basic Probability |
| **6** | M 2/17 | **Assessments 2** |
|  | W 2/19 | Binomial Distribution |
|  | F 2/21 | Normal Distribution |
| **7** | M 2/24 | Conditional Probability & <br>**Homework 3** |
